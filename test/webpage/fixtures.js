...
fixtures.elemFromString = function(html) {
   	var template = document.createElement('template');
   	template.innerHTML = html;
   	return template.content.firstChild;
}

fixtures.singleTextNode = function() {
...
fixtures.twoTextNodes = function() {
...
fixtures.threeTextNodes = function() {
...
fixtures.withNoscript = function() {
